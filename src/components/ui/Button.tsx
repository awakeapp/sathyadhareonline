...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Variants
    const variants = {
      primary: "bg-[var(--color-primary)] text-black hover:bg-[#ffed4a] shadow-sm active:scale-95 active:bg-[#ffed4a]/90",
      secondary: "bg-[var(--color-surface)] text-[var(--color-text)] hover:bg-[var(--color-surface-2)] shadow-sm active:scale-95",
