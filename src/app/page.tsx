  ...
  return (
    <PageContainer size="wide" className="min-h-[100svh] pt-2 pb-0 scroll-smooth">
      ...
      <a 
        ...
        className="block rounded-[2rem] p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-8 shadow-[0_20px_50px_rgba(104,93,230,0.12)] mt-[var(--header-height)] mb-12 bg-white dark:bg-[#111b21] border border-[var(--color-border)] overflow-hidden relative group active:scale-[0.98] transition-all"
      >
        ...
        <div className="sm:w-[60%] flex flex-col justify-center gap-3 relative z-10 text-center sm:text-left">
          <div className="flex items-center justify-center sm:justify-start gap-2 mb-1">
             <div className="w-8 h-8 rounded-full bg-[#25D366]/10 flex items-center justify-center text-[#25D366] min-w-[44px] min-h-[44px]">
