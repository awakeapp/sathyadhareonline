...
export default async function AdminLayout({
  ...
  // Only allow admin and super_admin; editors use /editor — middleware is the
  // primary guard, but we do a secondary check here for defence-in-depth.
  ...
  const navItems = [
    ...
    // Note: Settings page removed — placeholder link omitted until feature is built
  ];
