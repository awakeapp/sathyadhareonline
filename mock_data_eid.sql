-- Mock Data for Eid Al Adha Sequel (V2 - Strict Sequel Only)
-- This version ensures articles have is_standalone = false 
-- and correctly updates types for existing categories.
...
BEGIN
    ...
    -- 1. Ensure 'sequel' type for the Cover Story category
    INSERT INTO categories (name, slug, type, sort_order)
    VALUES ('Cover Story', 'cover-story', 'sequel', 1)
    ON CONFLICT (slug) DO UPDATE SET type = 'sequel', name = EXCLUDED.name
    ...
    -- 3. Articles (10 total) - Marked as is_standalone = false
    
    -- Editorial
    WITH new_article AS (
        INSERT INTO articles (title, slug, excerpt, content, status, author_id, published_at, is_standalone)
        VALUES (
            ...
            '<h1>Beyond the Ritual</h1><p>The essence of Eid Al Adha lies in the concept of "Qurbani" – nearness to the Divine...</p>',
            'published',
            auth_id,
            NOW(),
            false
        ) ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, is_standalone = false RETURNING id
    )
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>Beneath the desert''s golden crown...<br>The pilgrims stand in robes of white...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>The heat was unlike anything Omar had ever felt...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>The story of Prophet Ibrahim (AS) is the cornerstone of monotheism...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>Every year, millions of pounds of meat are distributed...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            'From the biryanis of India to the tajines of Morocco...',
            '<p>While the spiritual core remains identical, the cultural expressions of Eid are beautifully diverse...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            'Guidance on healthy eating habits during the festive period.',
            '<p>The Prophet (PBUH) taught us to eat in moderation...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>As stewards of the Earth, we must ensure that our rituals do not harm the environment...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>On the plains of Arafat, distinctions of rank, race, and wealth vanish...</p>',
            'published',
            auth_id,
            NOW(),
            false
    ...
    WITH new_article AS (
        ...
        VALUES (
            ...
            '<p>The real challenge of Eid Al Adha begins when the celebration ends...</p>',
            'published',
            auth_id,
            NOW(),
            false
